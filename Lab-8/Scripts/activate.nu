...
let virtual-env = "D:\ЖДТУ\1 семестр\Системи штучного інтелекту\Lab-8"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\ЖДТУ\1 семестр\Системи штучного інтелекту\Lab-8\Scripts\deactivate.nu"
