...
let virtual-env = "D:\ЖДТУ\1 семестр\Системи штучного інтелекту\Lab-5"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\ЖДТУ\1 семестр\Системи штучного інтелекту\Lab-5\Scripts\deactivate.nu"
